...
class _MonthlyScreenState extends State<MonthlyScreen> {
  ...
  Future<void> _initiatePayment() async {
    ...
    try {
      ...
      final paymentResponse = await _flutterwaveService.initiatePayment(
        ...
        transactionType: 'monthly',  // Specify that this is a monthly saving plan
      );
  ...
  // Fetch local or international monthly savings from Firestore
  Stream<QuerySnapshot> _getMonthlySavingsStream(bool isLocal) {
  ...
  Widget _buildMonthlySavingsList(bool isLocal) {
    return StreamBuilder<QuerySnapshot>(
      stream: _getMonthlySavingsStream(isLocal),
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
          return const Text('No monthly savings found.');
        }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildMonthlySavingsList(true),  // Local savings list
          ],
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _buildMonthlySavingsList(false),  // International savings list
          ],
        ),
      ),
    );
