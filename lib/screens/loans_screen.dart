...
class _LoansPageState extends State<LoansScreen> {
  DateTime? _startDate;
  DateTime? _endDate;
  List<Map<String, DateTime>> loansHistory = [];
  ...
  Future<void> _loadDates() async {
    DocumentSnapshot documentSnapshot =
        await loansCollection.doc('user_id').get();
  ...
  Future<void> _saveDates() async {
    try {
      await loansCollection.doc('user_id').set({
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              itemCount: loansHistory.length,
              itemBuilder: (BuildContext context, int index) {
                final entry = loansHistory[index];
  ...
  Future<void> _selectStartDate(BuildContext context) async {
    ...
    if (pickedDate != null) {
      setState(() {
        ...
        _addloansToHistory(); // Add selected date range to savings history
