...
class _OnceScreenState extends State<OnceScreen> {
  ...
  void _saveDefaults() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString('once_selected_day', _selectedDate.toString());
    prefs.setDouble('once_amount', _amount);
  }
  ...
  void _calculateTotalSavings() {
    ...
    int numberOfOnce = _selectedDate.difference(DateTime.now()).inDays ~/ 7;

    double principal = 0.0;
    for (int i = 0; i < numberOfOnce; i++) {
  ...
  void _saveAndPay() async {
    ...
    if (confirm == true) {
      ...
      final provider = Provider.of<OnceProvider>(context, listen: false);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Once returns: $_calculatedAmount USD (${(_calculatedAmount * _conversionRate).toStringAsFixed(2)} UGX)',
                  ...
                  return SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final onceReturns = transaction['amount'] + (transaction['amount'] * _interestRate);
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                Text('Once Returns: \$${onceReturns.toStringAsFixed(2)} (${(onceReturns * _conversionRate).toStringAsFixed(2)} UGX)'),
                              ],
                            ),
                            trailing: IconButton(
