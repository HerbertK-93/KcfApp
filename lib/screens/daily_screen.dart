...
class _DailyScreenState extends State<DailyScreen> {
  ...
  Future<void> _initiatePayment() async {
    ...
    try {
      ...
      final paymentResponse = await _flutterwaveService.initiatePayment(
        ...
        transactionType: 'Daily',  // Specify that this is a monthly saving plan
      );
  ...
  Stream<QuerySnapshot> _getDailySavingsStream(bool isLocal) {
    String currency = isLocal ? 'UGX' : 'USD';  // Local uses UGX, Intl uses USD
    return FirebaseFirestore.instance
        .collection('users')
        .doc(FirebaseAuth.instance.currentUser?.uid)
        .collection('transactions')
        .where('transaction_type', isEqualTo: 'Daily')
  ...
  Widget _buildDailySavingsList(bool isLocal) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDailySavingsList(true),  // Local savings list
          ],
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _buildDailySavingsList(false),  // International savings list
          ],
        ),
      ),
    );
